...
console.log(mixed.filter((each) => typeof each === 'string'));
...
console.log(
  'Jalasem,Taofeek,Edmum,Endurance,Goodness,Ibrahim'
    .split(',')
...
// const countriess = require('./countries_data');
